...
class SunglassesFragment : Fragment() {
    private var _binding: FragmentSunglassBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSunglassBinding.inflate(
            inflater,
            container,
            false
        )
    ...
    private fun fetchSunglasses() {
        viewModel.getProductsByCategory(categories = listOf("sunglasses"))
    ...
    private fun setSunglassesRecyclerView() {
        binding.rcvSunglasses.apply {
